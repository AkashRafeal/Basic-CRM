...
import { DealPriority } from '../../types/deal';
import { Flame, ArrowUp, AlertCircle, ArrowDown } from 'lucide-react';

interface DealPriorityBadgeProps {
  priority: DealPriority;
}

export const DealPriorityBadge: React.FC<DealPriorityBadgeProps> = ({ priority }) => {
  switch (priority) {
    case 'URGENT':
      return (
